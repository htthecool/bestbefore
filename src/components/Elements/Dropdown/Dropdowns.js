          ...
          <Col md={6}>
            <Card className="card-statistics mb-30">
              <CardBody>
                ...
                <Dropdown
                  isOpen={this.state.nocaretdemo}
                  toggle={this.nocaretdemo}
                >
                  <DropdownToggle color="success">Dropdown</DropdownToggle>
                  <DropdownMenu>
            ...
            <Card className="card-statistics mb-30">
              <CardBody>
                ...
                <div className="btn-toolbar" role="toolbar">
                  <Dropdown
                    group
                    isOpen={this.state.dropdownlg}
                    className="mb-1"
                    size="lg"
                    toggle={this.dropdownlg}
                  >
                  ...
                  &nbsp;&nbsp;
                  <Dropdown
                    isOpen={this.state.dropdownmd}
                    toggle={this.dropdownmd}
                  >
                    <DropdownToggle caret color="success">
                      Dropdown
                    </DropdownToggle>
                  ...
                  &nbsp;&nbsp;
                  <Dropdown
                    isOpen={this.state.dropdownsm}
                    size="xl"
                    toggle={this.dropdownsm}
                  >
              ...
              <CardBody>
                ...
                <div className="btn-toolbar" role="toolbar">
                  <Dropdown
                    group
                    direction="left"
                    isOpen={this.state.dropdownleft}
                    className="mb-1"
                    toggle={this.dropdownleft}
                  >
                    <DropdownToggle caret color="primary">
                      Left Dropdown
                    </DropdownToggle>
                  ...
                  &nbsp;&nbsp;
                  <Dropdown
                    isOpen={this.state.dropdownup}
                    direction="up"
                    toggle={this.dropdownup}
                  >
                    <DropdownToggle caret color="success">
                      Up Dropdown
                    </DropdownToggle>
